document.addEventListener('DOMContentLoaded', () => {
    ...
    formaDodaj.addEventListener('submit', (e) => {
        ...
        if (cijenaValue <= 0 || brojKarataValue <= 0) {
            prikaziNotifikaciju('Cijena i broj karata moraju biti veći od 0!', 'greska');
            return;
        }
